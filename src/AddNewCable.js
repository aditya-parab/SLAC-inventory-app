    ...
    return ( 
        <div>
            <Grid container className={classes.container} style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                {/* <Grid item md={12}> */}
<Typography style={{background:"#90030B",color:"white"}} variant="h2" >Add Cable details</Typography>
            ...
            <form noValidate autoComplete="off" >
                <TextField className={classes.field} fullw label="ID" variant="filled"  required></TextField>
